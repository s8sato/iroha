...
mod tests {
    ...
    fn generate_test_map() -> BTreeMap<core::any::TypeId, String> {
        ...
        insert_into_test_map!(iroha_executor_data_model::permission::trigger::CanRegisterAnyTrigger);
        insert_into_test_map!(iroha_executor_data_model::permission::trigger::CanUnregisterAnyTrigger);
